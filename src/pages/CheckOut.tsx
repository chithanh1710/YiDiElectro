...
import dataCarAll from "../data/dataProductPage";
...
export default function CheckOut() {
  const { id } = useParams();
  const findId = dataCarAll.findIndex((item) => item.name === id);
  const data = dataCarAll[findId];
    ...
    <div className="w-full lg:px-12 px-6 py-32 bg-gray-800 text-white">
      <div className="max-w-[1300px] mx-auto flex lg:flex-row flex-col rounded-xl overflow-hidden text-gray-700 font-semibold">
        ...
        >
          ...
          <div className="flex gap-4 justify-start mt-2">
            <img
              ...
              className={`lg:h-20 lg:w-auto sm:w-[120px] sm:h-[100px] transition-all duration-300 h-16 w-auto p-2 rounded-md border-2  ${
                card === 0
                  ? "bg-gray-400 border-yellow-400 shadow-md -translate-y-1 scale-105"
                  : "bg-white border-gray-400"
              }`}
              src={listImg.materCard}
              alt=""
            />
            <img
              onClick={() => {
              ...
              className={`lg:h-20 lg:w-auto sm:w-[120px] sm:h-[100px] transition-all duration-300 h-16 w-auto p-2 rounded-md border-2 border-gray-400 ${
                card === 1
                  ? "bg-gray-400 border-yellow-400 shadow-md -translate-y-1 scale-105"
                  : "bg-white border-gray-400"
              }`}
            ...
            <img
              ...
              className={`lg:h-20 lg:w-24 sm:w-[120px] sm:h-[100px] transition-all duration-300 h-16 w-20 object-contain p-2 rounded-md border-2 border-gray-400 ${
                card === 3
                  ? "bg-gray-400 border-yellow-400 shadow-md -translate-y-1 scale-105"
                  : "bg-white border-gray-400"
              }`}
        ...
        <div className="w-full lg:max-h-[680px] h-full bg-gray-100 px-4 py-6 lg:overflow-y-scroll productDetailCheckout">
          ...
          <img className="mt-24 mx-auto" src={data.img} alt="" />
